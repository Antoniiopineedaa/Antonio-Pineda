...
'  <meta property="og:image" content="' + esc(base) + '/assets/img/og-card.png?v=20260701" />',
'  <meta name="twitter:card" content="summary_large_image" />',
'  <meta name="twitter:image" content="' + esc(base) + '/assets/img/og-card.png?v=20260701" />',
...
'  <link rel="stylesheet" href="../styles.css?v=20260701" />',
'  <script type="application/ld+json">',
'  {"@context":"https://schema.org","@type":"Article","headline":' + JSON.stringify(title) + ',"author":{"@type":"Person","name":' + JSON.stringify(c.brand) + '},"datePublished":' + JSON.stringify(n.iso || "") + ',"inLanguage":"es","image":' + JSON.stringify(base + "/assets/img/og-card.png?v=20260701") + ',"mainEntityOfPage":' + JSON.stringify(canonical) + ',"isAccessibleForFree":' + (n.premium ? "false" : "true") + '}',
'  <\/script>',
'</head>',
'<body>',
...
'  <script defer src="../lib/data.js?v=20260701"></script>',
'  <script defer src="../main.js?v=20260701"></script>',
