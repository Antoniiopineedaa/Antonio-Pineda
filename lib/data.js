...
(function () {
  ...
  window.__SITE__ = {
    ...
    // Déjalo vacío "" y la web no usará ninguna cookie ni mostrará el aviso.
    // Con un ID puesto, GA solo se activa si el visitante pulsa "Aceptar".
    gaId: "G-CB0P3QRJWL",

    // Microsoft Clarity. Pega tu Project ID (lo encuentras en Clarity → Settings).
    // Se carga junto a GA, solo tras el consentimiento del usuario.
    clarityId: "xc4u51d7g0",
    ...
    /* -------------------------------------------------------------------------
       ...
       ---------------------------------------------------------------------- */
    beehiiv: {
      subscribeUrl: "https://casocero.beehiiv.com/subscribe",   // <<< EJEMPLO: "https://casocero.beehiiv.com/subscribe"
      embedUrl: ""        // <<< OPCIONAL: "https://embeds.beehiiv.com/xxxxxxxx"
    },

    /* -------------------------------------------------------------------------
       3 bis) KO-FI  —  aquí se cobra el PREMIUM (membresía de pago)
       -------------------------------------------------------------------------
       >>> Beehiiv (arriba) capta los correos y manda los casos GRATIS.
       >>> Ko-fi cobra el premium: el muro de pago de los artículos lleva aquí.
       >>> Pega la URL de tu página de Ko-fi (ej. https://ko-fi.com/tunombre).
       ---------------------------------------------------------------------- */
    kofiUrl: "https://ko-fi.com/antoniopinedaguerrero",
