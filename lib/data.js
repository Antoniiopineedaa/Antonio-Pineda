...
(function () {
  ...
  window.__SITE__ = {
    ...
    /* -------------------------------------------------------------------------
       3) CORREOS  —  muro de email (captación con Beehiiv)
       -------------------------------------------------------------------------
       >>> Ya no hay ninguna URL que pegar aquí. El formulario de la web manda
           el correo a la función /api/subscribe, que lo da de alta en Beehiiv.
       >>> La clave de Beehiiv vive en Vercel (variables de entorno), no aquí:
              BEEHIIV_API_KEY  y  BEEHIIV_PUBLICATION_ID
       >>> Al dejar el correo, se desbloquea TODO el premium de la web.
       ---------------------------------------------------------------------- */
